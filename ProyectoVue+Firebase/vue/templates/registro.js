...
//REGISTRO
    const Registro = { template: `
        <div>
            ...
            <nav class="header-noUser navbar container">
              <div class="container-fluid">
                ...
                <h1 class="pagina navbar-brand">Vue Js/Registro</h1>
              </div>
            </nav>
            </header>
            ...
            <div class="pcenter pgreen container mb-5">
                <h1 class="mt-5 h3">Registro al sistema</h1>
                ...
                <div class="formulario mt-5">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="email" class="form-control" placeholder="Email..." id="email" style="background-color: #202C39;color: #42b883;font-size: bold" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" placeholder="Password..." id="password2" style="background-color: #202C39;color: #42b883;font-size: bold" required>
                    </div>
                    ...
                    <button @click="registroUsuario" class="boton">Registrarse</button>
                    <button @click = "irLogin" class="boton">Volver al Login</button>
        ...
        `, methods: {
                ...Vuex.mapMutations(['irLogin']),
                ...Vuex.mapMutations(['registroUsuario'])
            }, 
        }
